  ...
  Gallium3D is Tungsten Graphics architecture for building 3D graphics drivers.
  Initially supporting Mesa and Linux graphics drivers, Gallium3D is designed to
  allow portability to all major operating systems and graphics interfaces.
  ...
  - [Gallium3D's Architectural Overview](https://gallium.readthedocs.io/en/latest/intro.html)
  - [Technical Overview](https://gallium.readthedocs.io/en/latest/index.html)
  - [Gallium3D talk from XDS 2007](https://www.freedesktop.org/wiki/Software/gallium/gallium3d-xds2007.pdf)
...
\page tgsi TGSI
  ...
  \sa tgsi_parse.h
  \sa [TGSI specification](https://gallium.readthedocs.io/en/latest/tgsi.html)
...
digraph {
  ...
  The graph above was generated by the [gprof2dot.py script](https://github.com/jrfonseca/gprof2dot).
